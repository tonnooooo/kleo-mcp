...
function header(i,t){
 if(project.style==='cinema')return;
...
function scene(s,u,t){
 if(project.style==='cinema'){window.KEOU_CINEMA.scene(s,u,t,timeline.scenes.indexOf(s));return}
