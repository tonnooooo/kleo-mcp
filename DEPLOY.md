...
| Prova gratuita | `FREE_CREDITS` = **7** (dal 14 set sera) | La prova gratuita resta (0 EUR, un bottone, niente da scrivere) ma **non compra un film**: il film più corto costa 10 crediti, quindi con i 7 regalati non si genera nulla su kie.ai; col pacchetto da 5 EUR (10 crediti) si arriva a 17, uno Short da 30 s. Decisione del proprietario: i film kie.ai si pagano dal primo. Il vecchio `FREE_FILMS` (regalo = un film al prezzo corrente) è sparito perché faceva l'opposto |
