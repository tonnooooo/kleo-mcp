...
- i crediti (1 credito = 2 secondi di film, minimo 10: 20 s = 10, 30 s = 15, 60 s = 30, 5 minuti = 150; nessun credito gratis all'iscrizione dal 14 set) si scalano quando il video entra in coda e tornano indietro per intero se fallisce o se viene annullato prima di partire; annullato a render iniziato torna solo la parte non ancora renderizzata;
