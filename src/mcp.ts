...
{"schema_version":1,"editorial_status":"ready","title":"The Treasure Nobody Ever Came Back For","brand":"Kleo","kleo_style":"cartoon","style":"picture","format":"9:16","language":"en","voice":"am_michael","speed":1.1,"music":"bed","max_duration":64,"scenes":[
 {"id":"01-hook","kind":"cinema","chapter":"01 THE CAPTAIN","accent":"red","title":"she never came back","hl":"never","voice":"In 1720, Captain Mara buried her treasure on Skull Beach. She never came back for it.","hold":0.2,"shots":[
  {"image_prompt":"A pirate captain with a red bandana and a long dark braid burying a wooden chest on a golden beach at sunset, palm trees, her red-sailed ship anchored in the bay","caption":"SHE NEVER CAME BACK","hl":"NEVER","motion":"in"},
  {"image_prompt":"The same pirate captain in her red bandana walking away along the shoreline at dusk, deep footprints in the wet sand, the beach empty behind her","at":"never came back","motion":"left"}]},
 {"id":"02-storm","kind":"cinema","chapter":"02 THE STORM","accent":"amber","title":"three days later","hl":"three","voice":"Three days later a storm took her ship, and only one cabin boy swam back to shore.","hold":0.2,"shots":[
  {"image_prompt":"The red-sailed pirate ship tossed by huge black waves at night, lightning splitting the sky, torn sails, rain across the deck","caption":"THREE DAYS LATER","hl":"THREE","motion":"in"},
  {"image_prompt":"A young cabin boy in a striped shirt clinging to a broken plank in the dark water, the ship going down behind him","at":"one cabin boy","motion":"out"},
  {"image_prompt":"The same cabin boy lying exhausted on an empty beach at dawn, calm turquoise water, palm trees, soft pink sky","at":"swam back","motion":"right"}]},
 {"id":"03-map","kind":"cinema","chapter":"03 THE MAP","accent":"green","title":"the same beach","hl":"same","voice":"He drew the map a hundred times, and every single copy pointed to the same beach.","hold":0.2,"shots":[
  {"image_prompt":"An old sailor with a white beard unrolling a worn treasure map on a table in a lantern-lit ship cabin, a green parrot perched beside him","caption":"A HUNDRED COPIES","hl":"HUNDRED","motion":"in"},
  {"image_prompt":"Close view of the worn map in warm candlelight, a black cross inked on a curved beach with three palm trees","at":"the same beach","motion":"out"}]},
 {"id":"04-closing","kind":"closing","chapter":"04 SKULL BEACH","accent":"cyan","title":"Is the gold still there?","hl":"still","voice":"So is the gold still there? Follow, and next time we dig up Skull Beach.","button":"Follow","hold":0.4,"shots":[
  {"image_prompt":"A half-buried wooden chest spilling gold coins into golden sand at dawn, a shovel stuck in the sand beside it, palm trees, calm sea","motion":"in"}]}]}
...
{"schema_version":1,"editorial_status":"ready","title":"The Last Night Train Across the Alps","brand":"Kleo","kleo_style":"realistic","style":"picture","format":"9:16","language":"en","voice":"bf_emma","speed":1.1,"music":"bed","max_duration":64,"scenes":[
 {"id":"01-platform","kind":"cinema","chapter":"01 THE PLATFORM","accent":"cyan","title":"nobody was waiting","hl":"nobody","voice":"At ten past midnight the platform was empty, and the night train was already boarding.","hold":0.2,"shots":[
  {"image_prompt":"An empty station platform at midnight, wet concrete reflecting cold blue lamps, a long sleeper train waiting with its windows lit","caption":"TEN PAST MIDNIGHT","hl":"MIDNIGHT","motion":"in"},
  {"image_prompt":"A conductor in a dark uniform standing in the lit doorway of the same sleeper train, warm yellow light behind him, cold breath in the air","at":"already boarding","motion":"left"}]},
 {"id":"02-cabin","kind":"cinema","chapter":"02 THE CABIN","accent":"amber","title":"two metres of Europe","hl":"metres","voice":"A sleeper cabin is two metres of Europe: a narrow bed, a folding sink, and a window that never stops moving.","hold":0.2,"shots":[
  {"image_prompt":"A narrow sleeper cabin at night, a made bed under a warm reading lamp, a small folding metal sink, shallow depth of field","motion":"in"},
  {"image_prompt":"The view through the same cabin window at night, dark mountains and scattered village lights streaking past the cold glass","at":"never stops moving","motion":"right"}]},
 {"id":"03-closing","kind":"closing","chapter":"03 SUNRISE","accent":"green","title":"You wake up in the mountains","hl":"mountains","voice":"You fall asleep in a city and wake up in the mountains. Follow for part two.","button":"Follow","hold":0.4,"shots":[
  {"image_prompt":"Sunrise over snowy alpine peaks seen from a moving train window, warm gold light on the rock, soft mist filling the valley below","motion":"out"}]}]}
